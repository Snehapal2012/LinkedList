...
public class SearchByValue {
    ...
    public static void insertStart() {
        SearchByValue list1 = new SearchByValue();
    ...
    public static void insertEnd() {
        SearchByValue list = new SearchByValue();
...
public static void searchValue(){
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            System.out.println("1) Insert at Start 2) Insert at End 3) Insert at Middle 4) Delete at Start 5) Delete at End 6) Search by Value 7) End of Operation ");
