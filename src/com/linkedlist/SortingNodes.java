...
public class SortingNodes {
    ...
    public void sorting(){
        Node current = head, index = null;  //Node current will point to head
        int temp;
        if(head == null) {
           System.out.println("Linked list is empty");
        }
    ...
    public static void insertStart() {
        SortingNodes list1 = new SortingNodes();
    ...
    public static void insertEnd() {
        SortingNodes list = new SortingNodes();
    ...
    public static void insertAtSpecificPosition(){
        ...
        list.display();
        System.out.println();
        System.out.println("We will insert 40 after 30");
        System.out.println();
        list.search(30);
    ...
    public static void sortingNodes(){
        SortingNodes list=new SortingNodes();
        list.insertingAtEnd(56);
        list.insertingAtEnd(30);
        list.insertingAtEnd(40);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            System.out.println("7) Insert at Specific Position 8) Delete at Specific Position 9) Sorting the Nodes 10) End of Operation");
            System.out.println();
